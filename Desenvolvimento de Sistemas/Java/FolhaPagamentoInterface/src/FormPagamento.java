...
public class FormPagamento extends javax.swing.JFrame {
    ...
    private void buttonCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCalcularActionPerformed
        ...
        double salario=(bruto+extra)-valorfaltas;
        double descontoir=15/100, descontoinss=12/100, descontoir2=20/100;
        double salariofinal;
        double salariofinal2;
        if (salario<=4000){
            salariofinal=salario-(descontoir*descontoinss);
            salariofinal2=salariofinal-(descontoir*salariofinal);
            this.textResultado.setText(salariofinal2+"R$");
        }
        else {
            salariofinal=salario-(descontoinss*salario);
            salariofinal2=salariofinal-(descontoir2*salariofinal);
            this.textResultado.setText(salariofinal2+"R$");
        } 
