...
public class FormAutonomo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtPercvendas = new javax.swing.JTextField();
        ...
        jLabel5.setText("Percentual Vendas");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
                    .addComponent(txtPercvendas, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(42, 42, 42)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(buttonCadastrar)
                    .addComponent(buttonExibir))
    ...
    private void buttonExibirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonExibirActionPerformed
        this.txtNumreg.setText(""+a.numreg);
        this.txtNome.setText(a.nome);
        this.txtTotalvendas.setText(""+a.totvendas);
        this.txtPercvendas.setText(""+a.percvendas);
    }//GEN-LAST:event_buttonExibirActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.txtResultado.setText(""+a.CalSalario());
    ...
    private void buttonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCadastrarActionPerformed
        a.numreg=Integer.parseInt(this.txtNumreg.getText());
        a.nome=this.txtNome.getText();
        a.totvendas=Double.parseDouble(this.txtTotalvendas.getText());
        a.percvendas=Double.parseDouble(this.txtPercvendas.getText());
        JOptionPane.showMessageDialog(null,"OS DADOS FORAM CADASTRADOS");
        this.txtNumreg.setText("");
        this.txtNome.setText("");
        this.txtTotalvendas.setText("");
        this.txtPercvendas.setText("");
    ...
    private javax.swing.JTextField txtPercvendas;
